...
const Bento = () => {
  return (
    <section id="bento" className="container mx-auto py-24 px-4 lg:px-6">
      <h1 className="text-xl font-medium text-center mx-auto pb-18 lg:w-160">Byggeri kræver papirarbejde, kontakter og kendskab til mange procedurer og regler, hvilket kan være svært at overskue uden den rigtige vejledning.</h1>
      <img src="" />
