...
const Bento = () => {
  return (
    <section id="bento" className="container mx-auto py-24 px-5">
      <h1 className="text-2xl font-semibold text-center mx-auto pb-18 lg:w-160">Byggeri kræver papirarbejde, kontakter og kendskab til mange procedurer og regler, hvilket kan være svært at overskue uden den rigtige vejledning.</h1>
      <img src="" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-12 px-12 text-primary">
        ...
        <div className="flex flex-col justify-between gap-6 opacity-100 -translate-y-6">
          ...
          <div className="h-full p-10 bg-backgroundsecondary rounded-sm">
            ...
            <p className="mt-12 font-semibold text-secondary text-xl">
